...
function Login({ providers }) {
  return (
    <div className="flex flex-col items-center space-y-20 pt-48 bg-black min-h-screen">
      
      <img src="https://srv2.imgonline.com.ua/result_img/imgonline-com-ua-Negative-luMN5toDjqbKXG8F.png" alt="" className="h-40 w-40 object-contain" />
      <div>
