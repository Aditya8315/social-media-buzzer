...
function Widgets({ trendingResults, followResults }) {
  return (
    <div className="hidden lg:inline ml-8 xl:w-[450px] py-1 space-y-5">
      ...
      <div className="text-[#d9d9d9] space-y-2 bg-[#15181c] pt-2 px-2 rounded-xl w-11/12 xl:w-9/12">
        ...
        {followResults.map((result, index) => (
          ...
          >
            ...
            <button className="ml-auto bg-white text-black rounded-full font-bold text-sm py-1 px-2">
              Follow
            </button>
          </div>
        ))}
